...
public class ExtentReporter implements ITestListener {
	...
	public static synchronized void initExtentDriver() throws Exception {
		...
		} else if (getPlatformFromtools().equals("Android") || getPlatformFromtools().equals("PWA") || getPlatformFromtools().equals("IOSBrowserStack")) {
	...
	public synchronized void appVersion() {
		if (getPlatform().equals("Android")) {
			...
			setAppVersion("Build " + DeviceDetails.getAppVersion(handler.getproperty("hrsPackage")).trim()
					.replace("versionName=", ""));
